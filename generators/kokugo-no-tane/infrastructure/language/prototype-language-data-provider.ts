...
export const PROTOTYPE_LEXICON = Object.freeze({
  ...
  two_people: { surface: "二人", reading: "ふたり", vocabulary_grade: 1 },
  place: { surface: "場所", reading: "ばしょ", vocabulary_grade: 1 },
  tree_nut: { surface: "木の実", reading: "きのみ", vocabulary_grade: 1 },
  make: { surface: "作る", reading: "つくる", vocabulary_grade: 1 },
  red: { surface: "赤い", reading: "あかい", vocabulary_grade: 1 },
