...
export const STORY_STANDARD_4Q_BLUEPRINT_ID = "story-standard-4q.v1";
export const STORY_RETRY_CRAFT_STRUCTURE_ID = "story-retry-craft.v1";
...
const TRAITS = Object.freeze([
  {
    ...
    expectation: (name, action) => `${name}は、|いそいで|${action}と|しました。`,
  },
  {
    term: "まけずぎらい",
    sentence: "まけずぎらいな|ひとです",
    expectation: (name, action) => `${name}は、|だれよりも|はやく|${action}と|しました。`,
  },
  {
    term: "こうきしんがつよい",
    sentence: "こうきしんがつよい|ひとです",
    expectation: (name, action) => `${name}は、|できあがりを|みたくて、|${action}と|しました。`,
  },
]);
...
function scenarioFromStoryPlan(storyPlan, topic) {
